...
static  $OJ_CSS="bing.css";  // bing.css | kawai.css | black.css | blue.css | green.css | hznu.css
...
static  $qiandao_update=true;
static  $OJ_PRINTER=false;  //启用打印服务
static  $OJ_MAIL=true; //内邮
...
static  $OJ_NOIP_KEYWORD="akoj的noip竞赛";  // 标题包含此关键词，激活noip模式，赛中不显示结果，仅保留最后一次提交。
...
static  $OJ_AI_HTML='<a class="desktop-only item active" target="_blank" href="http://ai.hustoj.com"><i class="help icon"></i>OJ AI</a>';; // 若想开启AI链接，可设为 '<a class="desktop-only item active" target="_blank" href="http://ai.hustoj.com"><i class="help icon"></i> 问问狗蛋</a>';
